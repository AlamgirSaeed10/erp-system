                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('updateeducationlevel') }}" method="POST">
                            {{csrf_field()}}
                            <input type="hidden" class="form-control" name="EducationLevelID" value="{{ $educationlevel->EducationLevelID }}">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="basicpill-firstname-input">Education Level*</label>
                                        <input type="text" class="form-control" name="educationlevelname" value=''>
                                    </div>
                                </div>
